...
pub(super) const STRINGS: Strings = Strings {
    ...
    reset_widget_position: "Reset Widget Position",
    reset_floating_position: "Reset Floating Window Position",
    language: "Language",
    ...
    codex_token_expired_body: "Sign in with Codex Desktop, or run 'codex' in a terminal and follow the prompts. Then refresh this app.",
