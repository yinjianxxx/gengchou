...
<img src=".github/readme/detail-popup-zh-dark.png" alt="详情弹窗：Claude Code 的 7 天窗口达 92% 被标记接近上限并高亮重置时间；Codex 51% 正常；Antigravity 空闲" width="440">

<sub>详情弹窗——包括接近上限时的警示样式。</sub>
...
到一枚托盘小数字，查配额不必再打开任何控制台。“更筹”原指古代夜间计时、
报更用的竹签，也可借指时间。
...
| **详情弹窗** | <img src=".github/readme/detail-popup-zh-dark.png" alt="详情弹窗（深色）" width="320"> | <img src=".github/readme/detail-popup-zh-light.png" alt="详情弹窗（浅色）" width="320"> |
